...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_testjavaproj17_9365;
            let db_auth = result.data.DB_AUTH_testjavaproj17_9365;
            let db_coll = result.data.DB_COLL_testjavaproj17_9365;
